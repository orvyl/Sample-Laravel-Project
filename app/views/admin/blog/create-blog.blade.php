...
<div class="fluid">
    <div class="widget grid12">
        <div class="whead"><h6>Blog Form</h6><div class="clear"></div></div>
        @foreach($errors->all('<p style="text-align: center">:message</p>') as $message)
            {{ $message }}
        @endforeach
        <div class="body">
        	<form method="post" action="{{ URL::to('admin/blog/createblog') }}" id="frmnewproduct" enctype="multipart/form-data">
        		<div class="formRow">
                    <div class="grid3"><label>Title:</label></div>
                    <div class="grid9"><input type="text" name="btitle" value="{{ Input::old('btitle') }}" class="required"/></div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <div class="grid3"><label>Content:</label></div>
                    <div class="grid9" style="border: 1px solid #d7d7d7">
                        <textarea id="editor" name="bcontent" rows="" cols="16">{{ Input::old('bcontent') }}</textarea>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">    
                ...
                <div class="formRow">
                    <input type="submit" class="buttonL bGreen floatR" value="+ Blog" />
                    <div class="clear"></div>
                </div>
