        ...
        <table cellpadding="0" cellspacing="0" border="0" class="dTable" id="dynamic">
	        ...
	        <tbody>
		        ...
		        <tr class="gradeA">
			        ...
			        <td class="tableActs">
			        	<a href="{{ URL::to('admin/users/editsuper/'.$row->id) }}" class="tablectrl_small bDefault tipS" title="Setting"><span class="iconb" data-icon="&#xe1f7;"></span></a>
                        <a href="#" class="tablectrl_small bDefault tipS delss" uid="{{ $row->id }}" title="Remove"><span class="iconb" data-icon="&#xe136;"></span></a>
                    </td>
		        </tr>
		        @endforeach
	        </tbody>
