...
<div class="sign-up">
	...
	<form action="{{ URL::to('registry/createothers') }}" method="post">
		...
		{{ Session::get('msg') }}
			<ul>
				<li>
					...
					<div class="c-r-select fl">
						<select name="occasion_type" id="acct-7" style="width:368px;">
							...
							<option name="" title="" selected>Others</option>
						</select>
					</div>
					<div class="clr"></div>
				...
				<li>
					<label for="">Occasion Description:</label>
					<input type="text" name="occasion_description" value="{{ Input::old('occasion_description') }}" placeholder="e.g Birthday, Graduation, etc..." required/>
					<div class="clr"></div>
					{{ $errors->first('occasion_description','<span style="color: white;"> :message</span>') }}
				</li>
				<li>
